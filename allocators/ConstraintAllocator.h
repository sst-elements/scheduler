...
namespace SST {
    namespace Scheduler {
        ...
        public:
            ...
            ConstrainedAllocation *allocate_constrained(Job *job,
                                                        std::vector <std::string> *constrained_leaves);
        ...
        private:
            ...
            bool try_to_remove_constraint_set(unsigned int num_constrained_needed,
