...
namespace SST {
    namespace Scheduler {
        ...
        protected:
            class MeshLocationOrdering
                : public std::binary_function<MeshLocation *, MeshLocation *, bool> {
            ...
            public:
                ...
                triple addwithrotate(triple origin, int coordinate, int offset, int mirror,
                                     rotation rot);

                void threedmark(triple curpoint, rotation *rotation, int *rank, int curdim,
                                triple *next, int *mirrors, int *inverse, int *rules);
            ...
            std::vector<std::vector < MeshLocation * >*>*
